...
kmax_bin           <-    31
klearning_rate     <-     0.0370198473489086
knum_iterations    <-   221
knum_leaves        <-   148
kmin_data_in_leaf  <-  1389
kfeature_fraction  <-     0.853991277009357
# agregado
kmax_depth        <- -1
#------------------------------------------------------------------------------
#------------------------------------------------------------------------------
#Aqui empieza el programa
setwd( "~/buckets/b1/exp/EntregaFinal/" )
