...
hs <- makeParamSet( 
         ...
         makeIntegerParam("min_data_in_leaf", lower=  0      , upper= 10000),
...
kdataset       <- "./dataset_final.csv.gz"
ksemilla_azar  <- 900007  #Aqui poner la propia semilla
kexperimento   <- "EntregaFinalBO"
ktraining      <- c( 202010, 202011, 202012, 202101, 202002 )   #periodos en donde entreno
