...
#cargo el dataset
dataset  <- fread("kaggle_competencia2_realidad.csv.gz")   #donde entreno


#creo la carpeta donde va el experimento
# DA  representa  Exploratory Data Analysis
dir.create( "./exp/DR6050/", showWarnings = FALSE )
setwd("./exp/DR6050/")   #Establezco el Working Directory DEL EXPERIMENTO
...
for( campo in  campos_buenos )
{
  tbl   <- dataset[ foto_mes<=202103 & get(campo)!=0,
           list( "promedio" = mean( get(campo), na.rm=TRUE)) ,
           foto_mes ]
